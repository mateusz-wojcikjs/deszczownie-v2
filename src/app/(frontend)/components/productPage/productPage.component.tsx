...
export const ProductPage = (props: ProductPageProps) => {
  const { product, children }: ProductPageProps = props
  ...
  return (
    <div className="">
      ...
      <div className="container mb-16 mt-24">
        ...
        <h4 className="text-center text-xl md:text-2xl lg:text-4xl mb-8 text-secondary-500">
          Jeżeli chcesz dowiedzieć się więcej o dodatkowym wyposażeniu deszczowni, kliknij poniżej:
        </h4>
            ...
            >
              <span className="flex gap-3">
                ...
                <Icon
                  ...
                  className="stroke-white fill-white group-hover:fill-primary-500 group-hover:stroke-primary-500"
                />
              </span>
            </a>
          </div>
